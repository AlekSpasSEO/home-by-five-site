...
const ICP = [
  "Помеѓу 20 и 100 вработени, семејна фирма во втора генерација",
  "Опрема и погон вредни над милион евра",
  "Европски сертификати и извоз, или сериозна амбиција за нив",
  "Синови и ќерки во менаџментот што сакаат да го тргнат минатиот век",
  "Маркетингот досега бил нечија дополнителна задача, не работно место",
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div>
            <Heading
              ...
              title="Ако ова ви личи на вашата фирма, читајте натаму."
              lede="Не работиме со сите. Овој систем е направен за компании што веќе имаат што да покажат, но никогаш немале кој да го покаже."
            />
